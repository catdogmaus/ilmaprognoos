...
# ... (Warnings, Precipitation, Temperature, Humidity, and Water sensors are unchanged) ...
...
# --- NEW SUNSHINE SENSOR CLASSES ---

class IlmaprognoosSunshineSensor(IlmaprognoosBaseSensor):
    """Base class for Sunshine Forecast sensors."""
